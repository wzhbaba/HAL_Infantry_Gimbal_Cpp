...
void GimbalInit()
{
    Gimbal.Position[0].Set(25.0f, 0.0f, 10.0f, 10000.0f, 2500.0f, 2500.0f, 15000.0f);
    Gimbal.Position[1].Set(25.0f, 0.0f, 5.0f, 10000.0f, 2500.0f, 2500.0f, 15000.0f);
    Gimbal.Speed[0].Set(50.0f, 0.0f, 0.0f, 25000.0f, 5000.0f, 0.0f, 30000.0f);
    Gimbal.Speed[1].Set(50.0f, 0.0f, 0.0f, 25000.0f, 2500.0f, 2500.0f, 30000.0f);
    ...
    Shoot.Trigger_Speed.Set(10.0f, 0.0f, 0.0f, 25000.0f, 5000.0f, 0.0f, 30000.0f);
    Shoot.Trigger_Current.Set(1.0f, 0.0f, 0.0f, 30000.0f, 0.0f, 0.0f, 30000.0f);
